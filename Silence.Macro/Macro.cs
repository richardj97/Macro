...
namespace Silence.Macro
{
    ...
    public class Macro
    {
        public delegate void KeyEventHandler(MacroEvent Event);
        public event KeyEventHandler OnKeyTrigger;
        public delegate void MouseEventHandler(MacroEvent Event);
        public event MouseEventHandler OnMouseTrigger;
